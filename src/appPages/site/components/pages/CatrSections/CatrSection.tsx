         ...
         {cart ? (
                           ...
                           <td>
                             <div className={scss.left_box}>
                               ...
                               <div className={scss.center}>
                                 ...
                                 <p className={scss.delete} onClick={() => handleDelete(item.id)}>удалить</p>
                               </div>
           ...
           <div className={scss.basket}>
             <div className={scss.basketBlock}>
               ...
               <p>Похоже, вы еще не добавили в корзину никаких товаров. Начните делать покупки, чтобы заполнить ее.</p>
