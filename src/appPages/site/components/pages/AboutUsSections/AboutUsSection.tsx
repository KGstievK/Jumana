        ...
        <div className={scss.content}>
          ...
          <div className={scss.second}>
            ...
            <div className={scss.title}>
              <h1>О бренде</h1>
              <p>
                Мы — интернет-магазин, который создаёт одежду для мусульманских
                женщин, объединяя традиции с современными модными тенденциями.
                Наша цель — предложить вам комфортную, стильную и качественную
                одежду, которая подчеркнёт вашу индивидуальность, сохраняя
                скромность.
              </p>
            </div>
          </div>
